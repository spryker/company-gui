 ...
 */
class CompanyToCustomerCompanyAttachForm extends AbstractType
{
    /**
     * @var string
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $formEvent): void {
            $this->handleCompanySearchPreSubmit($formEvent);
        });
    }
    ...
    protected function handleCompanySearchPreSubmit(FormEvent $formEvent): void
    {
        ...
        $companyChoices = $this->getFactory()
            ->createCompanyToCustomerCompanyAttachFormDataProvider()
